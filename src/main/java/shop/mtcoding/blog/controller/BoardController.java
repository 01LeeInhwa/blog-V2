...
public class BoardController {
    ...
    @PostMapping("/board")
    public @ResponseBody ResponseEntity<?> save(@RequestBody BoardSaveReqDto BoardSaveReqDto) { // @RequestBody : Json으로
                                                                                                // 받음
        ...
        return new ResponseEntity<>(new ResponseDto<>(1, "글쓰기 성공", null), HttpStatus.CREATED); // HttpStatus.CREATED :
                                                                                               // 201
    }
